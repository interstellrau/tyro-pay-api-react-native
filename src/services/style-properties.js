...
export const getSanitizedStyles = (styleProps) =>
  cleanStyles(styleProps, StyleProcessors);

export const ApplePayStyleProcessors = {
  buttonBorderRadius: {
    type: StyleTypes.size,
  },
  buttonStyle: {
...
export const getSanitizedApplePayStyles = (styleProps) =>
  cleanStyles(styleProps, ApplePayStyleProcessors);

export const GooglePayStyleProcessors = {
  buttonColor: {
    type: StyleTypes.text,
  },
  buttonType: {
...
export const getSanitizedGooglePayStyles = (styleProps) =>
